...
public class DgaMapperMicroarrayTest {
	...
	public void setupCVLung(Configuration conf) {
		...
		conf.set("ga.mapreduce.chromosome.length", "12600"); // Lung Cancer
		conf.set("ga.mapreduce.fitness.function",
				"edu.ibu.ga.mapreduce.logic.MicroarrayFeatureSelectionSvmCsvCvFitnessFunction");
		
	}

	public void setup14Tumors(Configuration conf) {
		...
		conf.set("ga.mapreduce.fitness.function",
				"edu.ibu.ga.mapreduce.logic.MicroarrayFeatureSelectionSVMCSVFitnessFunction");
		conf.set("ga.mapreduce.microarray.train.dataset",
				"file:///home/dino/workspace-jee/ga-mapred/data/14-tumors_train.csv");
		conf.set("ga.mapreduce.microarray.test.dataset",
				"file:///home/dino/workspace-jee/ga-mapred/data/14-tumors_test.csv");

	}
	
	public void setup11Tumors(Configuration conf) {
		// conf.set("ga.mapreduce.chromosome.length", "5726"); // 9 tumors
		conf.set("ga.mapreduce.chromosome.length", "12533"); // 11 tumors
		conf.set("ga.mapreduce.fitness.function",
				"edu.ibu.ga.mapreduce.logic.MicroarrayFeatureSelectionSVMCSVFitnessFunction");
		conf.set("ga.mapreduce.microarray.train.dataset",
				"file:///home/dino/workspace-jee/ga-mapred/data/11-tumors_train.csv");
		conf.set("ga.mapreduce.microarray.test.dataset",
				"file:///home/dino/workspace-jee/ga-mapred/data/11-tumors_test.csv");

	}
	
	public void setup9Tumors(Configuration conf) {
		conf.set("ga.mapreduce.chromosome.length", "5726"); // 9 tumors
		conf.set("ga.mapreduce.fitness.function",
				"edu.ibu.ga.mapreduce.logic.MicroarrayFeatureSelectionSVMCSVFitnessFunction");
		conf.set("ga.mapreduce.microarray.train.dataset",
				"file:///home/dino/workspace-jee/ga-mapred/data/9-tumors_train.csv");
		conf.set("ga.mapreduce.microarray.test.dataset",
				"file:///home/dino/workspace-jee/ga-mapred/data/9-tumors_test.csv");

	}

	public void setupGA(Configuration conf) {
		conf.set("ga.mapreduce.population.size.per.node", "10");
		...
		conf.set("ga.mapreduce.number.of.generations", "500");
	}
	...
	public void setup() throws IOException, InterruptedException {
		...
		this.setupGA(conf);
		//this.setup9Tumors(conf);
		//this.setup11Tumors(conf);
		this.setupCVLung(conf);
		...
		ChromosomeGenerator chromosomeGenerator = (ChromosomeGenerator) Util.initializeClass(conf,
				conf.get("ga.mapreduce.chromosome.generator"));
